...
const styles = StyleSheet.create({
    ...
    texts: { margin: 35, fontWeight: '100',textAlign: 'center', alignItems: 'center',  fontSize: 20,color:'#072C7D' },
    row: { flexDirection: 'row', backgroundColor: '#F7F7F9', width: '100%',borderBottomColor: '#BAC5DC',borderBottomWidth: 1, },
