  ...
  if (!filteredTabs.length) {
    return (
      <View style={{justifyContent: 'center', alignItems: 'center', flex: 2}}>
        <Image
          style={{width: 400, height: 210, marginTop: 10}}
          ...
          <View
                              ...
                              <View style={{marginLeft: '2%'}}>
                                ...
                                <View
                                  ...
                                  <Text
                                    ...
                                    {' '}
                                    {element.qanak.toString()}{' '}
                                    {element.quantityPrice}{' '}
                                  </Text>
                                </View>
                              </View>
                              <View>
                                ...
                                <View
                                  ...
                                  <Text
                                    ...
                                    {' '}
                                    {element.price
                                      ? element.price.toString().split('.0000')
                                      : ''}
                                    {element.price ? 'դրամ' : ''}
                                  </Text>
                                </View>
            ...
            <View
              ...
              <View
                ...
                <View style={{display: 'flex', flexDirection: 'row'}}>
                  <View style={{marginTop: 0, marginLeft: 8}}>
                    ...
                    <Text style={{fontSize: 18, color: '#F20732'}}>
                      Զեղչված գումար`{' '}
                      {orderDataZgin
                        ? orderDataZgin
                            .toFixed(2)
                  ...
                  <View>
                    <TouchableOpacity
                      ...
                      <Text style={styles.addText}>Հաստատել</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              </View>
              <Modal
                transparent={true}
                visible={
                  confirmOrderSuccess && confirmOrderSuccess[0].pstatus == 1
                }>
