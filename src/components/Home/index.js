...
const Home = ({
  ...
  return (
    <ImageBackground
      ...
      <TouchableOpacity
        onPress={() => store.dispatch(attemptLogOutSuccess())}
      ...
      <View style={styles.container}>
        <View
          ...
          style={
            itemWidth < 801
              ? styles.sectionContainerResponsive
        ...
        <View
          onLayout={onLayout}
          style={itemWidth < 801 ? styles.section3Responsive : styles.section3}>
          {loaderDebtList ? (
            <View style={[styles.containers, styles.horizontal]}>
              <ActivityIndicator size="large" color="#0000ff" />
            </View>
